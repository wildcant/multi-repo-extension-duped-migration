...
config :data_pipeline_cron_poc, DataPipelineCronPocWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: DataPipelineCronPocWeb.ErrorHTML, json: DataPipelineCronPocWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: DataPipelineCronPoc.PubSub,
  live_view: [signing_salt: "eqQQF0Z5"]
...
config :data_pipeline_cron_poc, DataPipelineCronPoc.Mailer, adapter: Swoosh.Adapters.Local

# Configure esbuild (the version is required)
config :esbuild,
  version: "0.25.4",
  data_pipeline_cron_poc: [
    args:
